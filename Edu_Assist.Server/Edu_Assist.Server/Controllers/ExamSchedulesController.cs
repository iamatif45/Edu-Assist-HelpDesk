...
//        public async Task<ActionResult<IEnumerable<ExamSchedule>>> Get()
//        {
...
//        [Authorize(Roles ="Admin,Staff")]
//        [HttpGet("{id}")]
//        public async Task<ActionResult<ExamSchedule>> Get(int id)
//        {
...
//        [HttpGet("exam/{id}")]
//        public async Task<ActionResult<ExamSchedule>> GetbyCourseId(int id)
//        {
...
//        [HttpPost]
//        public async Task<ActionResult<ExamSchedule>> Post([FromBody] ExamSchedule exam)
//        {
...
//        [Authorize(Roles = "Admin")]
//        [HttpPut("{id}")]
//        public async Task<ActionResult<ExamSchedule>> Put(int id, [FromBody] ExamSchedule exam
//            )
//        {
//            if (id != exam.ExamId)
//            {
